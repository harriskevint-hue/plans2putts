...
| `step1_washington.py` | **Step 1.** Pulls Washington golf-course names + addresses from OpenStreetMap into `courses` (coordinates stay NULL). **Not yet run against live Overpass** — see status below. |
